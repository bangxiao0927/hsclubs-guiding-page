...
describe('pageSchools', () => {
  ...
  // The card links to the school's front page, not to the machine-readable path the poller uses.
  it('offers the origin of the summary URL as the visitor-facing link', () => {
